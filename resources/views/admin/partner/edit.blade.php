    ...
    <div class="main-content">
        <div class="container-fluid">
            ...
            <div class="container">
                ...
                <form id="popup-save-form" action="{{ route('admin.partner.update', $model->id) }}" method="post" enctype="multipart/form-data" novalidate>
                    {{ csrf_field() }}
                    {{ method_field('put') }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="slug" name="website" value="{{ $model->website }}" required>
                                            </div>
                                        </div>
                                    </div>
